...
function promptForSession(session: Session, prompt: string): string {
  if (session.purpose === "materials") {
    return [
      ...
      "При необходимости прочитай учебное состояние в learning/LEARNING_DIARY.md и learning/ROADMAP.md, но не изменяй его.",
  ...
  const mentorContext = [
    ...
    "Сохраняй пользовательские правки и структуру учебных документов.",
    "Прочитай цель, дневник и roadmap в learning/LEARNING_DIARY.md и learning/ROADMAP.md.",
    "Источник учебного состояния — файлы learning/LEARNING_DIARY.md и learning/ROADMAP.md. Обновляй их напрямую, сохраняя разделы, историю и многострочные пункты. Старые указания использовать SQLite или ronix_learning_* устарели. Прочитай также AGENTS.md или AGENT.md проекта, если они есть.",
  ];
  if (session.purpose === "course") {
    return [
      ...
      "Если цель и маршрут ещё не определены, уточни цель, уровень и удобный формат обучения, затем сохрани их в учебных Markdown-файлах.",
      "Если маршрут устарел, скорректируй его в learning/ROADMAP.md с кратким основанием.",
      "",
      "Сообщение ученика:",
      prompt,
    ].join("\n");
  ...
  if (session.purpose === "practice") {
    return [
      ...
      "После завершённой практики запиши свидетельства в learning/LEARNING_DIARY.md с основанием и изменением оценки по правилам наставника.",
      "",
      "Сообщение ученика:",
      prompt,
    ].join("\n");
  ...
  return [
    ...
    "После проверки при необходимости запиши теоретическое наблюдение в learning/LEARNING_DIARY.md без изменения числовой оценки.",
    "Изменяй roadmap в learning/ROADMAP.md только если обнаруженный пробел действительно меняет учебный маршрут.",
    "Не изменяй исходный код проекта; учебные записи хранятся в Markdown-файлах learning.",
    "",
    "Вопрос ученика:",
    prompt,
  ].join("\n");
